    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">持法明洲后台管理系统</a>
            </div>
                <a class="navbar-text navbar-right">欢迎登陆${sessionScope.admin.username}</a>
                <a class="navbar-text navbar-right" href="${app}/admin/out">退出登录</a>
            </div>
        </div>
    </nav>
        <div class="container-fluid">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li><a href="javascript:$('#centerLay').load('./echarts.jsp')">用户活跃度管理</a></li>
                                        <li><a href="javascript:$('#centerLay').load('./map.jsp')">用户地区管理</a></li>
