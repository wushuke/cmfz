...
<script type="text/javascript">
        ...
        $("#articleTable").jqGrid(
            {
                ...
                styleUI: "Bootstrap",
                height: "400px",
                editurl: "${pageContext.request.contextPath}/article/del"
            }).jqGrid('navGrid', '#articlePage', { del : true,edit : false,add : false},{closeAfterDel:true})
    });
    // 点击添加文章时触发事件
    function showArticle() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/guru/allGuru",
            datatype: "json",
            type: "post",
